...
import { Droplet, Camera, TreePine, Bird, Globe, Fish, Sprout } from 'lucide-react';
...
const DEFAULT_CHALLENGES = [
  ...
  { id: 'c3', title: 'Identify 10 Birds', desc: 'Use the AI identifier to document 10 local bird species', pts: 100, deadline: 'Jul 1', participants: 3180, completed: true, emoji: React.createElement(Bird, { className: "w-5 h-5 text-yellow-500" }), category: 'Wildlife' },
  ...
  { id: 'c5', title: 'Water Conservation Week', desc: 'Track and reduce water usage by 20% for 7 days', pts: 80, deadline: 'Jul 7', participants: 980, completed: false, emoji: React.createElement(Droplet, { className: "w-5 h-5 text-blue-500" }), category: 'Conservation' },
  { id: 'c6', title: 'Eco Photography', desc: 'Submit 5 nature photos showcasing local biodiversity', pts: 120, deadline: 'Jul 20', participants: 1560, completed: false, emoji: React.createElement(Camera, { className: "w-5 h-5 text-gray-500" }), category: 'Creative' },
];

const DEFAULT_COMMUNITY_POSTS = [
  { id: 'f1', name: 'Forest Ecology', members: 12400, posts: 3840, latest: 'Fungi networks in old-growth forests', emoji: React.createElement(TreePine, { className: "w-5 h-5 text-green-500" }), category: 'Ecology' },
  { id: 'f2', name: 'Bird Watchers India', members: 8920, posts: 2160, latest: 'Migratory patterns in 2026 winter', emoji: '🦅', category: 'Birds' },
  { id: 'f3', name: 'Climate Action Hub', members: 21300, posts: 7200, latest: 'Urban heat islands - data analysis', emoji: React.createElement(Globe, { className: "w-5 h-5 text-blue-500" }), category: 'Climate' },
  { id: 'f4', name: 'Marine Conservation', members: 6840, posts: 1920, latest: 'Coral bleaching report: Lakshadweep', emoji: React.createElement(Fish, { className: "w-5 h-5 text-cyan-500" }), category: 'Marine' },
  { id: 'f5', name: 'Sustainable Living', members: 18600, posts: 5400, latest: 'DIY composting guide for apartments', emoji: React.createElement(Sprout, { className: "w-5 h-5 text-green-500" }), category: 'Sustainability' },
