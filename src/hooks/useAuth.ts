...
export const DEMO_USERS: Record<string, User> = {
  student: {
    ...
    ecoPoints: 2450,
    badges: [
      { id: 'b1', name: 'First Steps', icon: '🌱', description: 'Completed first course', earnedAt: '2025-01-20' },
      { id: 'b2', name: 'Tree Planter', icon: '🌳', description: 'Planted 10 trees', earnedAt: '2025-02-10' },
      { id: 'b3', name: 'Bird Watcher', icon: '🦋', description: 'Identified 20 species', earnedAt: '2025-03-05' },
      { id: 'b4', name: 'Eco Warrior', icon: '⚡', description: 'Completed 5 eco-challenges', earnedAt: '2025-04-01' },
    ],
  ...
  teacher: {
    ...
    ecoPoints: 5800,
    badges: [
      { id: 't1', name: 'Educator', icon: '🎓', description: 'Published first course', earnedAt: '2024-09-01' },
      { id: 't2', name: 'Mentor', icon: '🌟', description: 'Guided 100 students', earnedAt: '2024-11-15' },
    ],
  ...
  researcher: {
    ...
    ecoPoints: 9200,
    badges: [
      { id: 'r1', name: 'Researcher', icon: '🔬', description: 'Published 10 papers', earnedAt: '2024-07-20' },
      { id: 'r2', name: 'Field Expert', icon: '🏔️', description: 'Completed field study', earnedAt: '2024-10-05' },
    ],
  ...
  enthusiast: {
    ...
    ecoPoints: 3750,
    badges: [
      { id: 'e1', name: 'Bird Watcher', icon: '🦅', description: 'Identified 100 bird species', earnedAt: '2025-04-01' },
      { id: 'e2', name: 'Citizen Scientist', icon: '🌿', description: 'Contributed 50 observations', earnedAt: '2025-05-10' },
    ],
  ...
  ngo: {
    ...
    badges: [
      ...
      { id: 'n2', name: 'Impact Driver', icon: '💚', description: 'Engaged 500 volunteers', earnedAt: '2024-09-10' },
    ],
  ...
  admin: {
    ...
    ecoPoints: 32000,
    badges: [
      { id: 'a1', name: 'Platform Guardian', icon: '🛡️', description: 'Moderated 1000+ posts', earnedAt: '2024-01-01' },
      { id: 'a2', name: 'Super Admin', icon: '⭐', description: 'Full platform access', earnedAt: '2023-11-01' },
    ],
